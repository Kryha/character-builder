...
// import { getNftAuctionDetail, buyNft } from './auction.js';

import dappConstants from './lib/constants.js';
import { DisplayNftString } from './display-nft.jsx';
import { buyNft } from './auction.jsx';
...
function App() {
  ...
  const [nftPurse, setNftPurse] = useState(null);
  ...
  console.log(tokenDisplayInfo, tokenPetname, nftPurse, tokenPurses);
  ...
  useEffect(() => {
    ...
    const onConnect = async () => {
      ...
      await Promise.all([
        ...
        E(walletP).suggestIssuer('Nft', NFT_ISSUER_BOARD_ID),
      ]);
      ...
      for await (const nftsAvailableAmount of iterateNotifier(
        availableItemsNotifier,
      )) {
        setAvailableNfts(nftsAvailableAmount.value);
      }
    };
